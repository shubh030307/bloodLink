    ...
    return (
      <div className="flex h-64 items-center justify-center">
        <div className="animate-pulse flex flex-col items-center">
          <Droplet className="w-10 h-10 text-red-500 mb-2 animate-bounce" />
    ...
    <div className="max-w-7xl mx-auto space-y-6 -mt-4">
      ...
      <div className="flex justify-between items-end mb-8 mt-2">
        <div>
          ...
          <p className="text-gray-500 dark:text-slate-400 mt-1">Thank you for being a life saver. Your generosity brings hope.</p>
        </div>
      ...
      {/* Global OTP Alert */}
      {activeOtpAppt && (
        <div className="bg-red-50 dark:bg-red-900/20 border-2 border-red-500 rounded-2xl p-6 shadow-lg flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-red-600 dark:text-red-300 font-medium">Please provide this OTP to the collection staff to verify your blood donation.</p>
          </div>
          <div className="bg-white dark:bg-slate-800 border-2 border-red-300 dark:border-red-500/50 rounded-xl px-8 py-4 shadow-inner">
            <span className="text-4xl font-mono font-black tracking-[0.2em] text-gray-900 dark:text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 bg-white dark:bg-slate-800 rounded-[2rem] p-8 shadow-sm dark:shadow-none border border-gray-100 dark:border-slate-700 flex justify-between relative overflow-hidden">
          <div className="relative z-10 flex flex-col justify-center">
            <h3 className="text-gray-400 dark:text-slate-500 text-xs font-bold uppercase tracking-widest mb-4">Donation Status</h3>

            <div className="flex items-center space-x-3 mb-2">
              <CheckCircle className={`w-8 h-8 ${eligibility?.status === 'Eligible' ? 'text-green-500' : 'text-gray-400 dark:text-slate-600'}`} />
              <h2 className={`text-3xl font-extrabold ${eligibility?.status === 'Eligible' ? 'text-green-500' : 'text-gray-600 dark:text-slate-300'}`}>
          ...
          <div className="absolute right-0 bottom-0 top-0 w-1/2 flex items-center justify-end overflow-hidden z-0 pointer-events-none rounded-r-[2rem]">
            ...
            <div className="absolute w-64 h-64 bg-red-50 dark:bg-red-500/10 rounded-full -right-10 -top-10 opacity-70 blur-3xl"></div>
            ...
            <div className="relative w-48 h-48 flex items-center justify-center mr-8">
              ...
              <div className="absolute inset-2 bg-gradient-to-br from-white to-red-50 dark:from-slate-800 dark:to-slate-700 rounded-full shadow-[inset_0_-10px_20px_rgba(254,226,226,0.8),0_15px_35px_rgba(239,68,68,0.1)] dark:shadow-[inset_0_-10px_20px_rgba(0,0,0,0.5),0_15px_35px_rgba(0,0,0,0.5)] border border-red-50 dark:border-slate-700"></div>
              
              {/* Main Droplet */}
              <Droplet className="w-20 h-20 text-red-500 z-10 fill-red-500" style={{ filter: 'drop-shadow(0 10px 15px rgba(239,68,68,0.3))' }} />
              ...
              <div className="absolute bottom-12 left-10 w-5 h-5 bg-red-300 dark:bg-red-500 rounded-full opacity-40 blur-[2px]"></div>
              <Droplet className="absolute top-10 left-12 w-6 h-6 text-red-300 dark:text-red-500 z-0 fill-red-300 dark:fill-red-500 opacity-50 dark:opacity-30" style={{ transform: 'rotate(-15deg)' }} />
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 flex flex-col space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-[2rem] shadow-sm dark:shadow-none border border-gray-100 dark:border-slate-700 overflow-hidden">
            <div className="p-6 pb-4 flex justify-between items-center">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white flex items-center">
                <Calendar className="w-5 h-5 mr-2 text-red-500" />
                Upcoming Appointment
              </h3>
              <Link to="/donor/appointments" className="text-sm font-bold text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 transition-colors">View all</Link>
            </div>

            <div className="p-6 pt-0">
              {nextAppt ? (
                <div className="border border-gray-100 dark:border-slate-700 rounded-2xl p-5 flex flex-col md:flex-row gap-6 items-center hover:shadow-md transition-shadow bg-white dark:bg-slate-800/50 relative overflow-hidden">
                  ...
                  <div className="w-full md:w-40 h-32 rounded-[1.25rem] shrink-0 flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-gray-50 dark:from-slate-700 to-white dark:to-slate-800 border border-gray-100 dark:border-slate-600 shadow-[inset_0_2px_10px_rgba(0,0,0,0.02)]">
                    ...
                    <div className="absolute bottom-0 left-0 w-16 h-16 bg-red-50 dark:bg-red-800/20 rounded-full blur-xl opacity-80 -translate-x-1/2 translate-y-1/2"></div>
                    
                    <div className="relative w-16 h-16 bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-50 dark:border-slate-600 flex items-center justify-center">
                      <Building2 className="w-8 h-8 text-red-500" style={{ filter: 'drop-shadow(0 4px 6px rgba(239,68,68,0.2))' }} />
                    </div>
                  </div>
                  ...
                  <div className="flex-1 w-full relative z-10">
                    <div className="flex justify-between items-start mb-5">
                      <div>
                        <h4 className="font-extrabold text-gray-900 dark:text-white text-xl tracking-tight mb-1">{nextAppt.bloodBank?.name || 'Central Blood Bank'}</h4>
                        <p className="text-sm text-gray-500 dark:text-slate-400 flex items-center">
                          <MapPin className="w-4 h-4 mr-1 text-gray-400 dark:text-slate-500" />
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="flex items-center bg-white dark:bg-slate-700 px-5 py-2.5 rounded-xl border border-gray-100 dark:border-slate-600 text-sm font-bold text-gray-700 dark:text-slate-200 shadow-sm">
                ...
                <div className="text-center py-8 text-gray-500 dark:text-slate-400 bg-gray-50 dark:bg-slate-800/50 rounded-2xl border border-dashed border-gray-200 dark:border-slate-700">
                  <Calendar className="w-10 h-10 mx-auto text-gray-300 dark:text-slate-600 mb-2" />
            ...
            {/* Alert Strip */}
            <div className="bg-red-50 dark:bg-red-500/10 px-6 py-4 flex items-center border-t border-red-100 dark:border-red-900/30 text-sm">
          ...
          {/* Quick Actions */}
          <div className="bg-white dark:bg-slate-800 rounded-[2rem] p-6 shadow-sm dark:shadow-none border border-gray-100 dark:border-slate-700">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Quick Actions</h3>
            <div className="grid grid-cols-4 gap-4">
              <Link to="/donor/book" className="flex flex-col items-center justify-center p-4 rounded-2xl border border-gray-100 dark:border-slate-700 hover:shadow-md dark:hover:bg-slate-700/50 transition-all group cursor-pointer">
                <div className="w-12 h-12 rounded-full bg-red-50 dark:bg-slate-700 flex items-center justify-center mb-3 group-hover:bg-red-100 dark:group-hover:bg-slate-600 transition-colors">
                  <Calendar className="w-5 h-5 text-red-600 dark:text-red-400" />
                </div>
                <span className="text-xs font-bold text-gray-700 dark:text-slate-300 text-center">Book Donation</span>
              </Link>
              <Link to="/search" className="flex flex-col items-center justify-center p-4 rounded-2xl border border-gray-100 dark:border-slate-700 hover:shadow-md dark:hover:bg-slate-700/50 transition-all group cursor-pointer">
                <div className="w-12 h-12 rounded-full bg-red-50 dark:bg-slate-700 flex items-center justify-center mb-3 group-hover:bg-red-100 dark:group-hover:bg-slate-600 transition-colors">
                  <Droplet className="w-5 h-5 text-red-600 dark:text-red-400" />
                </div>
                <span className="text-xs font-bold text-gray-700 dark:text-slate-300 text-center">Find Blood</span>
              </Link>
              <div className="flex flex-col items-center justify-center p-4 rounded-2xl border border-gray-100 dark:border-slate-700 hover:shadow-md dark:hover:bg-slate-700/50 transition-all group cursor-pointer">
                <div className="w-12 h-12 rounded-full bg-red-50 dark:bg-slate-700 flex items-center justify-center mb-3 group-hover:bg-red-100 dark:group-hover:bg-slate-600 transition-colors">
                  <Users className="w-5 h-5 text-red-600 dark:text-red-400" />
                </div>
                <span className="text-xs font-bold text-gray-700 dark:text-slate-300 text-center">Invite Friends</span>
              </div>
              <Link to="/donor/history" className="flex flex-col items-center justify-center p-4 rounded-2xl border border-gray-100 dark:border-slate-700 hover:shadow-md dark:hover:bg-slate-700/50 transition-all group cursor-pointer">
                <div className="w-12 h-12 rounded-full bg-red-50 dark:bg-slate-700 flex items-center justify-center mb-3 group-hover:bg-red-100 dark:group-hover:bg-slate-600 transition-colors">
                  <FileText className="w-5 h-5 text-red-600 dark:text-red-400" />
                </div>
                <span className="text-xs font-bold text-gray-700 dark:text-slate-300 text-center">Donation History</span>
              </Link>
            </div>
          </div>
        ...
        <div className="lg:col-span-4 flex flex-col space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-[2rem] p-6 shadow-sm dark:shadow-none border border-gray-100 dark:border-slate-700 flex-1">
            <div className="flex justify-between items-center mb-6">
              ...
              <button className="text-sm font-bold text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 transition-colors">View all</button>
            </div>
