  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-foreground">My Appointments</h2>
      </div>

      {loading ? (
        <div className="text-center py-10 text-gray-500 dark:text-muted-foreground animate-pulse">Loading appointments...</div>
                ...
                {appt.status === 'BOOKED' && (
                  <>
                    ...
                    <button 
                      ...
                      className="bg-white dark:bg-card hover:bg-destructive/10 text-destructive border border-red-200 px-5 py-2.5 rounded-xl font-medium transition-all flex items-center justify-center"
                    >
