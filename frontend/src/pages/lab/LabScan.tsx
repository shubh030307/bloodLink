  ...
  return (
    <div className="p-6 max-w-3xl mx-auto min-h-[calc(100vh-100px)] flex flex-col justify-center">
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Verify Blood Bag</h1>
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 shadow-sm">
        <form onSubmit={handleScan} className="mb-6">
          ...
          <div className="flex gap-3">
            <input 
              ...
              className="flex-1 px-4 py-3 text-lg rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-red-500 outline-none disabled:opacity-50"
            />
            {!successData && (
              <button 
                type="submit"
        ...
        {!successData && !showScanner && (
          <div className="mb-6 flex justify-center">
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-medium rounded-xl hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
            >
        ...
        {showScanner && !successData && (
          <div className="mb-6 relative">
            <button
              ...
              className="absolute top-2 right-2 z-10 p-2 bg-white/80 dark:bg-black/50 backdrop-blur rounded-full hover:bg-white dark:hover:bg-black text-gray-800 dark:text-white"
            >
              <X className="w-5 h-5" />
            </button>
            <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
              <div id="reader" className="w-full text-gray-800 dark:text-gray-200 [&_a]:text-blue-500 [&_button]:bg-gray-100 [&_button]:dark:bg-gray-800 [&_button]:px-4 [&_button]:py-2 [&_button]:rounded-lg [&_button]:mt-2"></div>
            </div>
          </div>
        )}
        ...
        {successData && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-300">
            <div className="p-5 rounded-xl border border-green-200 bg-green-50 dark:bg-green-900/20 dark:border-green-900/50 mb-6">
              ...
              <div className="grid grid-cols-2 gap-y-4 gap-x-6 text-sm">
                <div>
                  <p className="text-gray-500 dark:text-gray-400">Unit Number</p>
                  <p className="font-semibold text-gray-900 dark:text-white">{successData.unitNumber}</p>
                </div>
                <div>
                  <p className="text-gray-500 dark:text-gray-400">Status</p>
                  <span className="inline-flex px-2 py-1 rounded bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 font-medium text-xs mt-1">
                    {successData.status}
                  </span>
                </div>
                <div>
                  <p className="text-gray-500 dark:text-gray-400">Blood Group</p>
                  <p className="font-semibold text-gray-900 dark:text-white">{successData.bloodGroup}</p>
                </div>
                <div>
                  <p className="text-gray-500 dark:text-gray-400">Collection Center</p>
                  <p className="font-semibold text-gray-900 dark:text-white">{successData.collectionCenter?.name}</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <button 
                ...
                className="flex-1 py-3 px-4 border border-gray-200 dark:border-gray-700 font-medium rounded-xl text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
              >
                Cancel
              </button>
              <button 
