  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-black text-gray-900 dark:text-white">Laboratory History</h1>
          <p className="text-gray-500 text-sm mt-1">Review finalized lab reports and testing decisions.</p>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {history.map((report) => (
                  <tr key={report.id} className="border-b border-gray-50 dark:border-slate-700 hover:bg-gray-50/50 dark:hover:bg-slate-700/50 transition-colors">
